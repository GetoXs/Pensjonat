...
namespace PensjonatApp.DS {
    ...
    public partial class UslugiDS : global::System.Data.DataSet {
        ...
        public partial class UslugiDataTable : global::System.Data.TypedTableBase<UslugiRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UslugiRow AddUslugiRow(int id_pobytu, int id_pracownika, string dodatkowy_opis, System.DateTime termin, int id_slownikowe_uslugi) {
        ...
        public partial class UslugiRow : global::System.Data.DataRow {
            ...
            public System.DateTime termin {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableUslugi.terminColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'termin\' in table \'Uslugi\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableUslugi.terminColumn] = value;
                }
            }
            ...
            public bool IsterminNull() {
                return this.IsNull(this.tableUslugi.terminColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetterminNull() {
                this[this.tableUslugi.terminColumn] = global::System.Convert.DBNull;
            }
...
namespace PensjonatApp.DS.UslugiDSTableAdapters {
    ...
    public partial class UslugiTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.Odbc.OdbcParameter("IsNull_termin", global::System.Data.Odbc.OdbcType.Int, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "termin", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.Odbc.OdbcParameter("Original_termin", global::System.Data.Odbc.OdbcType.DateTime, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "termin", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Uslugi] ([id_pobytu], [id_pracownika], [dodatkowy_opis], [termin], [" +
                "id_slownikowe_uslugi]) VALUES (?, ?, ?, ?, ?)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.Odbc.OdbcParameter("termin", global::System.Data.Odbc.OdbcType.DateTime, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "termin", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Uslugi] SET [id_pobytu] = ?, [id_pracownika] = ?, [dodatkowy_opis] = ?, [termin] = ?, [id_slownikowe_uslugi] = ? WHERE (([id_uslugi] = ?) AND ((? = 1 AND [id_pobytu] IS NULL) OR ([id_pobytu] = ?)) AND ((? = 1 AND [id_pracownika] IS NULL) OR ([id_pracownika] = ?)) AND ((? = 1 AND [dodatkowy_opis] IS NULL) OR ([dodatkowy_opis] = ?)) AND ((? = 1 AND [termin] IS NULL) OR ([termin] = ?)) AND ((? = 1 AND [id_slownikowe_uslugi] IS NULL) OR ([id_slownikowe_uslugi] = ?)))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.Odbc.OdbcParameter("termin", global::System.Data.Odbc.OdbcType.DateTime, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "termin", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.Odbc.OdbcParameter("IsNull_termin", global::System.Data.Odbc.OdbcType.Int, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "termin", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.Odbc.OdbcParameter("Original_termin", global::System.Data.Odbc.OdbcType.DateTime, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "termin", global::System.Data.DataRowVersion.Original, false, null));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_uslugi, id_pobytu, id_pracownika, dodatkowy_opis, termin, id_slownikowe" +
                "_uslugi FROM Uslugi";
            ...
            this._commandCollection[2].CommandText = "SELECT id_uslugi, id_pobytu, id_pracownika, dodatkowy_opis, termin, id_slownikowe" +
                "_uslugi\r\nFROM     Uslugi\r\nWHERE  (id_uslugi = ?)";
            ...
            this._commandCollection[3].CommandText = @"SELECT Uslugi.id_pracownika, Uslugi.dodatkowy_opis, Uslugi.termin, Uslugi.id_pobytu, Uslugi_slownik.cena, Uslugi_slownik.nazwa, Uslugi_slownik.opis
...
WHERE  Uslugi.id_slownikowe_uslugi = Uslugi_slownik.id_slownikowe_uslugi AND (Uslugi.id_pobytu = ?)";
            ...
            this._commandCollection[4].CommandText = @"SELECT Klienci.imie, Klienci.nazwisko, Pokoje.nr_pokoju, Uslugi_slownik.nazwa, Uslugi_slownik.opis, Uslugi.dodatkowy_opis, Uslugi.termin
...
WHERE  Uslugi.id_slownikowe_uslugi = Uslugi_slownik.id_slownikowe_uslugi AND Uslugi.id_pobytu = Pobyty.id_pobytu AND Pobyty.id_klienta = Klienci.id_klienta AND 
            ...
            this._commandCollection[5].CommandText = "UPDATE       Uslugi\r\nSET                id_pracownika = ?\r\nWHERE        (id_uslug" +
                "i = ?)";
            ...
            this._commandCollection[5].Parameters.Add(new global::System.Data.Odbc.OdbcParameter("Original_id_uslugi", global::System.Data.Odbc.OdbcType.Int, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "id_uslugi", global::System.Data.DataRowVersion.Original, false, null));
            this._commandCollection[6] = new global::System.Data.Odbc.OdbcCommand();
            this._commandCollection[6].Connection = this.Connection;
            this._commandCollection[6].CommandText = "UPDATE       Uslugi\r\nSET                id_pobytu = ?, dodatkowy_opis = ?, termin" +
                " = ?, id_slownikowe_uslugi = ?\r\nWHERE        (id_uslugi = ?)";
            ...
            this._commandCollection[6].Parameters.Add(new global::System.Data.Odbc.OdbcParameter("termin", global::System.Data.Odbc.OdbcType.DateTime, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "termin", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._commandCollection[6].Parameters.Add(new global::System.Data.Odbc.OdbcParameter("Original_id_uslugi", global::System.Data.Odbc.OdbcType.Int, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "id_uslugi", global::System.Data.DataRowVersion.Original, false, null));
        }
        ...
        public virtual int Delete(int Original_id_uslugi, global::System.Nullable<int> Original_id_pobytu, global::System.Nullable<int> Original_id_pracownika, string Original_dodatkowy_opis, global::System.Nullable<global::System.DateTime> Original_termin, global::System.Nullable<int> Original_id_slownikowe_uslugi) {
            ...
            if ((Original_id_slownikowe_uslugi.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((int)(Original_id_slownikowe_uslugi.Value));
            }
            else {
        ...
        public virtual int Insert(global::System.Nullable<int> id_pobytu, global::System.Nullable<int> id_pracownika, string dodatkowy_opis, global::System.Nullable<global::System.DateTime> termin, global::System.Nullable<int> id_slownikowe_uslugi) {
            if ((id_pobytu.HasValue == true)) {
            ...
            if ((id_slownikowe_uslugi.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[4].Value = ((int)(id_slownikowe_uslugi.Value));
            }
            else {
        ...
        public virtual int Update(global::System.Nullable<int> id_pobytu, global::System.Nullable<int> id_pracownika, string dodatkowy_opis, global::System.Nullable<global::System.DateTime> termin, global::System.Nullable<int> id_slownikowe_uslugi, int Original_id_uslugi, global::System.Nullable<int> Original_id_pobytu, global::System.Nullable<int> Original_id_pracownika, string Original_dodatkowy_opis, global::System.Nullable<global::System.DateTime> Original_termin, global::System.Nullable<int> Original_id_slownikowe_uslugi) {
            if ((id_pobytu.HasValue == true)) {
            ...
            if ((id_slownikowe_uslugi.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(id_slownikowe_uslugi.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[4].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_id_uslugi));
            if ((Original_id_pobytu.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_id_pobytu.Value));
            }
            else {
            ...
            if ((Original_id_pracownika.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_id_pracownika.Value));
            }
            else {
            ...
            if ((Original_dodatkowy_opis == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_dodatkowy_opis));
            }
            if ((Original_termin.HasValue == true)) {
            ...
            if ((Original_id_slownikowe_uslugi.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((int)(Original_id_slownikowe_uslugi.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int UpdateQuery(global::System.Nullable<int> id_pobytu, string dodatkowy_opis, global::System.Nullable<global::System.DateTime> termin, global::System.Nullable<int> id_slownikowe_uslugi, int Original_id_uslugi) {
            ...
            if ((termin.HasValue == true)) {
                command.Parameters[2].Value = ((System.DateTime)(termin.Value));
            }
            else {
                command.Parameters[2].Value = global::System.DBNull.Value;
            }
            if ((id_slownikowe_uslugi.HasValue == true)) {
                command.Parameters[3].Value = ((int)(id_slownikowe_uslugi.Value));
            }
            else {
                command.Parameters[3].Value = global::System.DBNull.Value;
            }
            command.Parameters[4].Value = ((int)(Original_id_uslugi));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
