...
WHERE  Uslugi.id_slownikowe_uslugi = Uslugi_slownik.id_slownikowe_uslugi AND Uslugi.id_pobytu = Pobyty.id_pobytu AND Pobyty.id_klienta = Klienci.id_klienta AND 
            ...
            this._commandCollection[3].CommandText = @"SELECT Klienci.imie, Klienci.nazwisko, Pokoje.nr_pokoju, Uslugi_slownik.nazwa, Uslugi_slownik.opis, Uslugi.dodatkowy_opis, Uslugi.termin_start, Uslugi.termin_koniec, Uslugi.zrealizowane
FROM     Uslugi, Uslugi_slownik, Pobyty, Klienci, Pokoje
WHERE  Uslugi.id_slownikowe_uslugi = Uslugi_slownik.id_slownikowe_uslugi AND Uslugi.id_pobytu = Pobyty.id_pobytu AND Pobyty.id_klienta = Klienci.id_klienta AND 
            ...
            this._commandCollection[6].CommandText = @"SELECT        Uslugi_slownik.cena, Uslugi_slownik.nazwa, Uslugi_slownik.opis, Uslugi_slownik.id_stanowiska, Uslugi.id_uslugi, Uslugi.id_pobytu, Uslugi.id_pracownika, 
                         Uslugi.dodatkowy_opis, Uslugi.termin_start, Uslugi.termin_koniec, Uslugi.id_slownikowe_uslugi, Uslugi.zrealizowane, Pobyty.id_pokoju, Pobyty.id_rezerwacji, 
                         Pobyty.id_rachunku, Pobyty.id_klienta
FROM            Uslugi, Uslugi_slownik, Pobyty
WHERE        Uslugi.id_slownikowe_uslugi = Uslugi_slownik.id_slownikowe_uslugi AND Uslugi.id_pobytu = Pobyty.id_pobytu AND (Pobyty.id_rezerwacji = ?)";
...
WHERE  Uslugi.id_slownikowe_uslugi = Uslugi_slownik.id_slownikowe_uslugi AND Uslugi.id_pobytu = Pobyty.id_pobytu AND Pobyty.id_klienta = Klienci.id_klienta AND 
        ...
        public virtual UslugiDS.UslugiDataTable GetDataByIDPracownikaDoCzasu(global::System.Nullable<int> id_pracownika, global::System.Nullable<global::System.DateTime> termin_koniec) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual UslugiDS.UslugiDataTable GetDataUslugiUslugiSlownikPobytyByIdRezerwacji(global::System.Nullable<int> id_rezerwacji) {
...
WHERE  Uslugi_slownik.id_stanowiska = Pracownicy_slownik.id_stanowiska AND (Uslugi_slownik.id_slownikowe_uslugi = ?)";
            ...
            this._commandCollection[3] = new global::System.Data.Odbc.OdbcCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = @"SELECT        Uslugi_slownik.id_slownikowe_uslugi, Uslugi_slownik.cena, Uslugi_slownik.nazwa AS nazwaUslugi, Uslugi_slownik.opis AS opisUslugi, 
                         Pracownicy_slownik.nazwa, Pracownicy_slownik.opis, Uslugi_slownik.id_stanowiska
FROM            Uslugi_slownik, Pracownicy_slownik
WHERE        Uslugi_slownik.id_stanowiska = Pracownicy_slownik.id_stanowiska";
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.Odbc.OdbcParameter("nazwa", global::System.Data.Odbc.OdbcType.NVarChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "nazwa", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[4].Parameters.Add(new global::System.Data.Odbc.OdbcParameter("opis", global::System.Data.Odbc.OdbcType.NVarChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "opis", global::System.Data.DataRowVersion.Current, false, null));
